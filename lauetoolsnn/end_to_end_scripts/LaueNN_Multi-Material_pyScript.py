...
if __name__ == '__main__':     #enclosing required because of multiprocessing
    ...
    input_params = {
                    ...
                    "SG": [186, 227],                     ## Space group of material_ (None if not known)
                    "hkl_max_identify" : [5,5],        ## Maximum hkl index to classify in a Laue pattern
                    "nb_grains_per_lp" : [1,1],        ## max grains to be generated in a Laue Image
                    ...
                    #  ## Training parameters
                    # =============================================================================
                    "orientation_generation": "random", ## only supports random for multi material
                    ...
                    "grid_size_x" : 6,            ## Grid X and Y limit to generate the simulated dataset (a rectangular scan region)
                    "grid_size_y" : 6,
    ...
    if run_prediction_MM:
        ...
        ##The probelm is in the function below
        # Matching rate
